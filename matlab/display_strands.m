...
%	args: 
%         dirname or strand struct - the directory from which the strands are to be loaded or strand struct.
%         tube divisions - Number of divisions of tube cross sections (i.e. 6 => hexagonal tubes)
%         bundle_colours - ColourSpec colours for each of the bundles to be
%         plotted. (randomly generated if left blank
%         
%
%	display_strands
